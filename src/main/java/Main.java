...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //word count
        updateWordCount(wordsWithSpace, word_count);
        ...
        while(numMerges-- > 0) {
            ...
            pair_count = countPairs(wordsWithSpace, vocab_count, topPair);
    ...
    private static void updateWordCount(List<String> tokenizedText, Map<String, Integer> word_count) {
        word_count.clear();
        tokenizedText
                .stream()
            ...
            for (int i = 0; i < splitWord.length - 1; i++) {
                ...
                pair_count.put(key,
                        pair_count.getOrDefault(key, 0)
                                + vocab_count.getOrDefault(splitWord[i] + " ", 0)
                                + vocab_count.getOrDefault(splitWord[i + 1] + " ", 0)
                );
